...
public enum ConfigUtil {
    ...
    protected Logger logger = LogManager.getLogger(ConfigUtil.class);
//    private final static String SUFFIX = ".properties";
    ...
    public String getProperty(String key) {
        ...
        logger.info("param:【{}】, result:【{}】", new Object[]{key, result});
        return result;
    }
    ...
    public <T> T getProperty(String key, String defaultValue, Class<T> clazz) {
        ...
        return StringUtil.strToObj(str, clazz);
    }
