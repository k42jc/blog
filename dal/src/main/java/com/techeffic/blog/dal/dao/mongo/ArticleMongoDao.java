...
import com.techeffic.blog.common.util.RandomUtil;
import com.techeffic.blog.dal.dao.IArticleDao;
import com.techeffic.blog.dal.entity.mongo.Article;
...
public class ArticleMongoDao extends BaseMongoDao<Article> implements IArticleDao {
	...
	public List<Article> findRandomArticles(int n) {
		...
		return this.getMongoTemplate().find(query.skip(RandomUtil.nextInt(count>=0?count:1)).limit(n), Article.class);
	}
