 ...
 public class ImageUtils { 
 	...
 	public static void main(String[] arg) { 
 		...
 		for (int i = 0; i < 10; i++) { 
 			...
 			mypic.compressPic("C:\\Users\\Administrator\\Desktop\\", "E:\\imgeTest\\", "IMG_2146.jpg", "r1"+i+".jpg", 120, 120, false); 
 			int end = (int) System.currentTimeMillis(); // 结束时间 
 			int re = end-start; // 但图片生成处理时间 
 			count += re; System.out.println("第" + (i+1) + "张图片压缩处理使用了: " + re + "毫秒"); 
 			System.out.println("输出的图片大小：" + mypic.getPicSize("E:\\imgeTest\\r1"+i+".jpg")/1024 + "KB"); 
 		}
