...
ClipboardSwf:'clipboard.swf',Version:"1.5.1"}};dp.SyntaxHighlighter=dp.sh;
...
dp.sh.Toolbar.Create = function(b) {
    var _code = b.CssClass;
    if(_code == 'dp-xml'){
    	_code = 'xml';
    }else if(_code == 'dp-j'){
    	_code = 'java';
    }else if(_code == 'dp-sql'){
    	_code = 'sql';
    }else if(_code == 'dp-py'){
    	_code = 'python';
    }else if(_code == 'dp-css'){
    	_code = 'css';
    }else if(_code == 'dp-jscript'){
    	_code = 'javascript';
    }else if(_code == 'dp-php'){
    	_code = 'php';
    }
...
"dp-php"};dp.sh.Brushes.Php.prototype=new dp.sh.Highlighter;dp.sh.Brushes.Php.Aliases=["php"];
...
"gm"),css:"keyword"}];this.CssClass="dp-jscript"};dp.sh.Brushes.JScript.prototype=new dp.sh.Highlighter;dp.sh.Brushes.JScript.Aliases=["js","jscript","javascript"];
